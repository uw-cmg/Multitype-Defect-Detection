...
#Higher NMS
proposal_params = {'min_size': 4,'nms_thresh':0.5}
model = FasterRCNNVGG16(n_fg_class=3, pretrained_model='../BestWeightPerformance/BestWeight_20190702.npz', ratios=[ 0.5, 1, 1.5, 2, 2.5, 4,8,16],anchor_scales=[1, 4, 8, 16], min_size=1024, max_size=1024,proposal_creator_params=proposal_params)
