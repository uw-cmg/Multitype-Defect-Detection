...
class Annealing(extension.Extension):
    ...
    def __init__(self, attr, rate, init=None, target=None, optimizer=None):
        ...
        self._t = 0
        self._RestartValue = 0.0
        self._currentRate = 0.0
    ...
    def initialize(self, trainer):
        ...
        if self._init is None:
            ...
            self._RestartValue = self._init
            self._currentRate = self._init
    ...
    def __call__(self, trainer):
        ...
        # custom code for lr scheduling
        if self._t % 100 is 0:
            value = self._RestartValue * 0.9
            self._RestartValue = value
            self._currentRate = value
        else:
            value = self._currentRate * self._rate
            self._currentRate = value
        # end of custom code
