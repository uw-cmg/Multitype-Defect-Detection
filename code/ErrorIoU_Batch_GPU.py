...
#load Data
root = '../Data3TypesYminXminYmaxXmax9'
...
model = FasterRCNNVGG16(n_fg_class=3, pretrained_model='../modelResults/snapshot_model_100000_dataset4_20180831.npz', ratios=[ 0.5, 1, 1.5, 2, 2.5, 4,8,16],anchor_scales=[1, 4, 8, 16], min_size=1024, max_size=1024,proposal_creator_params=proposal_params)
