...
correct, cls_error,loc_error,confMatrix,area_loc_error_list,gtNumDefects = evaluate_set_by_iou_kinds(model,
                                                                                                     dataset_test,bbox_label_names, threshold=0.2, threshold_IoU = 0.5)
